...
var getSeveridades = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
    var sqlPool1, request, severidades;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 7;
            return request.query("SELECT * FROM SGV_MOE_LogSeverity");

          case 7:
            severidades = _context.sent;
  ...
  return function getSeveridades(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.getSeveridades = getSeveridades;